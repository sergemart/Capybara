...
public class CreateFamilyRetryDialogFragment extends DialogFragment {
    ...
    public Dialog onCreateDialog(@Nullable Bundle savedInstanceState) {
        AlertDialog alertDialog = new AlertDialog.Builder(Objects.requireNonNull( super.getActivity() ))
            .setTitle(ResStore.get().getCreateFamilyRetryDialogTitleR(mCause))
            .setMessage(ResStore.get().getCreateFamilyRetryDialogMessageR(mCause))
            .setIcon(ResStore.get().getCreateFamilyRetryDialogIconR(mCause))
     ...
     */
    public static CreateFamilyRetryDialogFragment newInstance(Throwable cause) {

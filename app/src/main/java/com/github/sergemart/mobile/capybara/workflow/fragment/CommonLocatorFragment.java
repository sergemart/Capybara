    ...
    extends AbstractFragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (GeoService.get().isPermissionGranted() ) GeoService.get().startLocationUpdates();
        return fragmentView;
    }
    ...
    private void setViewListeners() {
        ...
        pViewDisposable.add(GeoService.get().getLocateMeSubject().subscribe(location -> {
        ...
        pViewDisposable.add(MessageRepo.get().getLocationReceivedSubject()
